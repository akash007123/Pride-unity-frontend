...
const statusVariants: Record<string, { variant: 'default' | 'secondary' | 'destructive' | 'outline', className: string }> = {
  ...
  contacted: { variant: 'secondary', className: 'bg-blue-500 hover:bg-blue-600' },
  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-rose-600 via-pink-500 to-purple-600 p-8 text-white"
      >
        ...
        >
          ...
          <div className="rounded-full bg-white/10 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm backdrop-blur-sm">
            <span className="font-semibold">{stats?.data?.byStatus?.contacted || 0}</span> contacted
          </div>
          <div className="rounded-full bg-white/10 px-3 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm backdrop-blur-sm">
            ...
            <CardContent className="pt-6 relative">
              ...
              <div className="relative flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold mt-1">{stats?.data?.byStatus?.contacted || 0}</p>
                </div>
      ...
      {/* Volunteers Table with Row Animations */}
      <motion.div variants={itemVariants}>
        <Card className="overflow-hidden">
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="bg-muted/50">
                      ...
                      <TableHead className="hidden lg:table-cell font-semibold">Roles</TableHead>
